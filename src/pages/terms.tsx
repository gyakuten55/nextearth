...
const sections = [
  {
    title: '第1条（適用）',
    body: [
      '本利用規約（以下「本規約」といいます。）は、株式会社NextEarth（以下「当社」といいます。）が提供する不用品回収、買取、リサイクル、その他関連サービス（以下「本サービス」といいます。）の利用に関する条件を、本サービスを利用するお客様（以下「利用者」といいます。）と当社との間で定めるものです。',
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-gray-600 leading-loose mb-12">
                この利用規約（以下「本規約」といいます。）は、株式会社NextEarthが提供する各種サービスのご利用条件を定めるものです。利用者の皆さまには、本規約に従って本サービスをご利用いただきます。
              </p>
